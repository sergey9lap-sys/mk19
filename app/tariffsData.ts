...
export const tariffBonuses = [
  {
    ...
    items: [
      "При покупке тарифа 2 «Персональный трек» начисляем вам кэшбек в виде бонусных 5 900 Р на счёт для оплаты любых обучений в Академии.",
      "При покупке тарифа 3 «Масштаб с Александрой» начисляем вам 24 900 Р на бонусный счёт.",
      "Подарок для тарифа 3: приглашение на встречу участников премиальной программы «Визионеры» в июле.",
    ],
    note: "Вы заходите в обучение с компенсацией стоимости внутри системы.",
  },
  {
    eyebrow: "Бонус для участников 2 и 3 тарифа",
    title: "Персональная встреча с Александрой",
    items: [
      "Среди всех оплативших во время эфира будет разыграна персональная встреча / видео-сессия с Александрой.",
      "Розыгрыш — во вторник утром.",
    ],
