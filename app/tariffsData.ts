...
export const tariffBonuses = [
  {
    ...
    items: [
      "При оплате тарифа 2 «Персональный трек» начисляем вам грант на обучение в виде бонусных 5 900₽ на счёт для оплаты любых обучений в Академии — бонус сгорит 18.06",
      "При оплате тарифа 3 «Масштаб с Александрой» начисляем вам грант на обучение в размере 19 900₽ на бонусный счёт — бонус сгорит 18.06",
      "При оплате 3 тарифа вы получаете приглашение на встречу участников премиальной программы «Визионеры» в июле — бонус сгорит 17.06",
    ],
  },
  {
    tone: "draw",
