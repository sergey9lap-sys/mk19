...
export const tariffBonuses = [
  {
    ...
    items: [
      "При покупке тарифа 2 «Персональный трек» начисляем вам грант на обучение в виде бонусных 5 900₽ на счёт для оплаты любых обучений в Академии.",
      "При покупке тарифа 3 «Масштаб с Александрой» начисляем вам грант на обучение в размере 24 900₽ на бонусный счёт.",
      "🎁 приглашение на встречу участников премиальной программы «Визионеры» в июле.",
      "❗️ Эти бонусы доступны в течении 24 часов!",
    ],
  },
  {
    tone: "draw",
    eyebrow: "🎁 Бонус для участников 2 и 3 тарифа",
    title: "День с Александрой",
    items: [
      "Среди всех оплативших во время эфира будет разыгран день с Александрой / видео-сессия с Александрой.",
    ],
